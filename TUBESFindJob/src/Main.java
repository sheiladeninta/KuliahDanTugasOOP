...
public class Main {
    ...
    private static void login(Scanner scanner) {
        ...
        // Validasi login (diimplementasikan sesuai kebutuhan)
        // Contoh sederhana: user dengan username "user123" dan password "password123"
    ...
    private static void registerUser(Scanner scanner) {
        // Implementasi pendaftaran pengguna (diimplementasikan sesuai kebutuhan)
        // Anda dapat menambahkan validasi, penyimpanan data pengguna, dll.
        System.out.println("Fitur pendaftaran belum diimplementasikan.");
    }
